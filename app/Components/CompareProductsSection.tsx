      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row justify-center gap-8">
            <motion.select
              className="w-full md:w-96 px-6 py-4 bg-gray-900 border border-gray-700 rounded-lg text-gray-400 focus:outline-none cursor-pointer"
            ...
            <table className="w-full border-collapse">
              ...
              <thead>
                <tr>
                  ...
                  {[0, 1].map((_, idx) => (
                    <td key={idx} className="pb-12 text-center">
                      <motion.div
                        className="w-64 h-80 mx-auto bg-gray-900 rounded-2xl flex flex-col items-center justify-center border border-gray-800 gap-4"
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
