  ...
  return (
    <div className="h-screen flex overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-black overflow-hidden">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-bold tracking-widest">Craft Your Signature</h2>
          <p className="text-xl md:text-2xl text-gray-300 mt-6 font-light max-w-md">
            Indulge in timeless elegance and unforgettable scents that define you.
          </p>
        </motion.div>
      </div>

      {/* Right Side - Register Form with Formik Validation */}
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-white px-8">
        ...
        >
          <div className="text-center">
            ...
            <p className="mt-3 text-gray-600 text-base md:text-lg">Join us and explore exclusive fragrances</p>
          </div>
          ...
          <form onSubmit={formik.handleSubmit} className="space-y-5">
            ...
            {formik.touched.terms && formik.errors.terms && (
              <p className="text-red-500 text-sm -mt-3">{formik.errors.terms}</p>
            )}
